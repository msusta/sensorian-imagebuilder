...
wget www.airspayce.com/mikem/bcm2835/bcm2835-1.50.tar.gz -O bcm2835-1.50.tar.gz || { echo "Failed to download bcm2835 library" && exit; }
...
if [ "$bcm2835_sha512"=="$checksum_sha512_bcm2835" ]
	then
		...
		echo "Checksum verification FAILED. Something went wrong while downloading bcm2835-1.50.tar.gz"
		echo "Exiting..."
		exit
fi
